...
CREATE TABLE IF NOT EXISTS `vehicle_management`.`employees` (
  ...
  INDEX `fk_employees_offices_idx` (`offices_officeCode` ASC) VISIBLE,
  INDEX `fk_employees_employees1_idx` (`employees_employeeNumber` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `vehicle_management`.`customers` (
  ...
  INDEX `fk_customers_employees1_idx` (`employees_employeeNumber` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `vehicle_management`.`orders` (
  ...
  INDEX `fk_orders_customers1_idx` (`customers_customernumber` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `vehicle_management`.`payments` (
  ...
  INDEX `fk_payments_customers1_idx` (`customers_customernumber` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `vehicle_management`.`products` (
  ...
  INDEX `fk_products_productlines1_idx` (`productlines_productLine` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `vehicle_management`.`orders_has_products` (
  ...
  INDEX `fk_orders_has_products_products1_idx` (`products_productCode` ASC, `products_productlines_productLine` ASC) VISIBLE,
  INDEX `fk_orders_has_products_orders1_idx` (`orders_orderNumber` ASC, `orders_customers_customernumber` ASC) VISIBLE,
